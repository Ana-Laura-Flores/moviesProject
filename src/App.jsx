  ...
  return (
    ...
    <FavoriteContextProvider>
      ...
      <Routes>
        ...
        ></Route>
        <Route path="/novedades" element={<MoviesTypes type="now_playing" titleType="Novedades" />}></Route>
        <Route path="/populares" element={<MoviesTypes type="popular" titleType="Populares"/>}></Route>
        <Route path="/top10" element={<MoviesTypes type="top_rated" titleType="Más Votadas"/>}></Route>
